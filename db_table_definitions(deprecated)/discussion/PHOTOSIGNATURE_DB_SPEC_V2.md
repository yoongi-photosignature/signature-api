# PhotoSignature MongoDB Schema v2

> ⚠️ **Superseded by v3. See MONGODB_SCHEMA_V3.md**

> **Created:** 2025-12-10
> **Project:** PhotoSignature New System
> **Version:** 2.0 (Review Applied)
...
### 4. Active Popup Sales (Two-Step Query)
...
### 5. Cancelled/Refunded Transactions
...
| v1 | v2 | Reason |
|----|----|----|
| `payment.cardNo` | Removed | Security (PCI DSS) |
| `popup.isActive` | Removed | No batch update needed, check popups.status |
| - | `status` field added | Cancel/refund handling |
| - | `payment.pgProvider` added | PG tracking |
| - | Exchange rate caching in Firebase | Rate limit prevention |
